...
export interface MenuItem {
  ...
  available?: boolean;
  promoInfo?: string;
  promoType?: 'bundle_price' | 'buy_x_get_y'; // 'bundle_price' (Diskon paket harga) atau 'buy_x_get_y' (Beli X Gratis Y)
  promoPrice?: number; // Contoh: 5000 untuk paket promo harga
  promoMinQty?: number; // Syarat minimal beli: misal 2 (Beli 2)
  promoFreeQty?: number; // Jumlah item gratis: misal 1 (Gratis 1)
  promoActive?: boolean; // Toggle aktifkan perhitungan promo otomatis
}
